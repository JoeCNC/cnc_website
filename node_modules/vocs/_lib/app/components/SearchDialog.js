...
import { ArrowLeftIcon, ChevronRightIcon, ListBulletIcon, MagnifyingGlassIcon, FileIcon, } from '@radix-ui/react-icons';
...
export function SearchDialog(props) {
    ...
    const results = useMemo(() => {
        ...
        setSelectedIndex(0);
        return searchIndex.search(searchTerm).slice(0, 16);
