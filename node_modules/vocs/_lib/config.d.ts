...
export declare function defineConfig<colorScheme extends ColorScheme = undefined>({ blogDir, font, head, ogImageUrl, rootDir, title, titleTemplate, ...config }: Config<false, colorScheme>): Promise<ParsedConfig>;
